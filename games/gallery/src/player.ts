...
export class Player extends Walker {
  ...
  constructor(scene: THREE.Scene, sheet: THREE.Texture, blockers: Blocker[], heightAt: (x: number, z: number, fromY?: number) => number) {
    super(scene, sheet, 1.8, blockers, heightAt);
    this.place(0, 12.5);
  }
